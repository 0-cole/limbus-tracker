...
const KENNETH_SPECIFIC_MEMOS = {
  'v1.0.56': "Someone slipped an eerie acoustic cassette tape into the Mephistopheles intercom and now the records terminal is pulling back its own window margins like theater curtains! Charon reported seeing an ominous face peering through the spatial folds of the dashboard right before the monitor erupted into deafening static. I have reinforced the physical window framing with K Corp adhesive, re-typed the typography buffer so words don't snap in half, and sanitized the audio bus. If you hear someone whispering while you're cataloging Sinners, DO NOT whisper back.",
